...
## 项目初衷
最初是想利用 GitHub Pages 搭建个人博客，虽然可以用其他平台来写，但就是有点想试试折腾一下，想着自己最近学习的过程，突然觉得也许博客也挺有必要的，所以我利用docsify和GitHub pages建了一个简单的网站，不过要写什么的话，还真没这方面的经验，想到什么写什么好了（话说真的会有人看这种半吊子的东西吗233），目前是打算用来记录学习过程中遇到的问题、技术总结和个人思考。一个是这个 Markdown 格式简洁易维护，一个是 Docsify 快速生成文档网站。
